...
#if defined(AT32F415xx) || defined(AT32F413xx) || defined(AT32F403_7xx) || defined(AT32F402_5xx) || defined(AT32F435_7xx) || defined(AT32F423xx)
...
// #endif
...
#elif defined(AT32F415xx) || defined(AT32F413xx) || defined(AT32F403_7xx) || defined(AT32F402_5xx) || defined(AT32F435_7xx) || defined(AT32F423xx)
    spiConfig.ctrl1 = 0;
    ...
    switch (roundedDivisor) {
        case 2:
            break;
        case 4:
            spiConfig.ctrl1 |= SPI_CTRL1_MDIV_4;
            break;
        case 8:
            spiConfig.ctrl1 |= SPI_CTRL1_MDIV_8;
            break;
        case 16:
            spiConfig.ctrl1 |= SPI_CTRL1_MDIV_16;
            break;
        case 32:
            spiConfig.ctrl1 |= SPI_CTRL1_MDIV_32;
            break;
        case 64:
            spiConfig.ctrl1 |= SPI_CTRL1_MDIV_64;
            break;
        case 128:
            spiConfig.ctrl1 |= SPI_CTRL1_MDIV_128;
            break;
        case 256:
            spiConfig.ctrl1 |= SPI_CTRL1_MDIV_256;
            break;
        case 512:
            spiConfig.ctrl2 |= SPI_CTRL2_MDIV_512_1024;
            break;
        case 1024:
            spiConfig.ctrl1 |= SPI_CTRL1_MDIV_1024;
            spiConfig.ctrl2 |= SPI_CTRL2_MDIV_512_1024;
            break;
    }
#else
